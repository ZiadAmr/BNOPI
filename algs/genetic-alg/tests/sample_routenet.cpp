...
int main(int argc, char** argv) {
	...
	Stop stop2("stop2", 1, 0, 0.001);
	Stop stop3("stop3", 1, 0, 0.002);
	Stop stop4("stop4", 1, 0.001, 0.001);

	Link link1(1, "1=>2", 0.001, &stop1, &stop2);
	Link link2(1, "2=>3", 0.001, &stop2, &stop3);
	Link link3(1, "2=>4", 0.001, &stop2, &stop4);
