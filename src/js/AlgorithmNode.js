  ...
  return (
    <div className='depNode'>
      ...
      <div>
        ...
        <Button variant ='secondary' id="addNode" size= 'sm'><FontAwesomeIcon icon={faPlus}/></Button>
        <Button variant ='secondary' id="deleteNode" size= 'sm'><FontAwesomeIcon icon={faMinus}/></Button>
