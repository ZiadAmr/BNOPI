 ...
 * @property {number} id
 * @property {string | undefined} name
 * @property {google.maps.Polyline[]} links Polylines connecting each consecuting pair of bus stops.
 * @property {google.maps.Polyline[]} continuityLinks Polylines composed of 2 points connecting each link to the next. These are not editable by the user directly, but will automatically update when a link is changed.
 * @property {number[]} stops Ids of bus stops in this route.
 * @property {any} hidden_attrs Data related to this route that is needed to reconstruct the stage instance from which this route was loaded. Not displayed to the UI user.
 * @property {any} user_attrs Data related to this route that is needed to reconstruct the stage instance from which this route was loaded. Editable by the UI user.
 */
...
/**
 * Structure of how the renderer keeps track of instances that are displaying in the stage tracker.
 * @typedef {Object} StageInstanceInfo
 * @property {string} path Path to the metadata file (.stg.json) file of the stage instance
 * @property {InstanceMetadata} metadata Contents of the metadata file of this stage instance.
 * @property {StageFormatInfo | undefined} stageFormatInfo Defined only if a .fmt.js file is loaded for this format. If so, it contains information about the stage format. 
 */
